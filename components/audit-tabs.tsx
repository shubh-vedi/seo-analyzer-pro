...
import { Info, Code, Share2, Database, Link2, AlertCircle, Sparkles } from "lucide-react"

interface AuditTabsProps {
  data: ScrapedData & { scoreBreakdown: Record<string, number>; issues: { type: string; message: string }[] }
  aiTips: AiTip[] | null
}
